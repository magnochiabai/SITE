...
function gradeJS(obj){
	...
	var arrayObjLastColx	= [];
	var arrayObjLastColy	= [];
	var contaObjLastCol		= 1;
	var cX 					= 1;
	$.each(blocoClass, function(key, value){
		arrayObjLastColx.push($this.data('x'));
		arrayObjLastColy.push($this.data('y'));

		contaObjLastCol	= parseInt(arrayObjLastColy.length);
		console.log(contaObjLastCol);
	...
	//console.log(arrayObjLastColy[3]);
